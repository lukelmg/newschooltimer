...
if (isMobile == false) { // desktop
  ...
  lineHeightNew = (24.5) + (-1.99 * periodScheduleArray[currentScheduleSelected]) + (0.0514 * (periodScheduleArray[currentScheduleSelected] * periodScheduleArray[currentScheduleSelected]));
...
1. get size of table
2. get size of bigDiv
3. while size of table < bigDiv increase font size
...
*/
  ...
  var myTableWidth = parseInt(myTable.offsetWidth);
  var bigDivWidth = parseInt(bigDiv.offsetWidth);

  while (myTableWidth < bigDivWidth) {
    sizeOfFont = sizeOfFont + 0.1;
  }
